...
*/
public class FontColorChooser extends JFrame {
	...
	private void initGUI() {
		{
			...
			this.setSize(500, 600);
			{
				...
				colorTitle.setText("Select a font color");
	...
	protected void selectButtonAction() {
		Mediator.getInstance().setFontColor(colorChooser.getColor(),this);
	}
	protected void cancelButtonAction() {
		this.setVisible(false);
	}
	protected void colorSelectedAction() {
		colorTitle.setForeground(colorChooser.getColor());
	}
	
	public static void main(String[] args) {
		FontColorChooser chooser = new FontColorChooser();
